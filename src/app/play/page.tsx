...
export default function PlayPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-12">
      <h1 className="mb-2 text-fluid-h1 font-bold text-balance text-brand-900 dark:text-brand-100">
        Ask the Agent
      </h1>
      <p className="mb-6 text-sm text-brand-600 dark:text-brand-400">
        Ask the agent anything about Mario — &ldquo;Why should we hire you?&rdquo;,
        &ldquo;What&apos;s your biggest weakness?&rdquo;. It answers in a self-deprecating, funny
        way, grounded in real resume facts, streaming live from AWS Lambda. Or hit &ldquo;Why hire
        me?&rdquo; for an instant pitch.
      </p>
      ...
      <figure className="no-print mt-16 flex flex-col items-center gap-3 border-t border-brand-200 pt-10 dark:border-brand-800">
        <Image
          ...
          className="h-auto w-full max-w-[260px] rounded-2xl border border-brand-200 shadow-lg grayscale transition duration-500 hover:grayscale-0 sm:max-w-[320px] dark:border-slate-700"
        />
