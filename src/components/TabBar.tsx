...
export function TabBar() {
  ...
  return (
    <nav
      className="no-print sticky top-0 z-50 border-b border-brand-200 bg-brand-bg/80 py-2.5 backdrop-blur-md pt-safe px-safe dark:border-brand-800 dark:bg-brand-900/80"
      aria-label="Main navigation"
    >
      <div className="mx-auto flex w-full max-w-6xl items-center justify-between gap-2 px-4 sm:gap-3 sm:px-6">
        {/* Left group — tabs */}
