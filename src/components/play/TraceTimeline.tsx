...
export function TraceTimeline({ events, mockMode }: TraceTimelineProps) {
  ...
  return (
    <div
      ref={scrollRef}
      className={cn(
        "relative max-h-[28rem] min-h-[12rem] overflow-y-auto rounded-lg bg-[#0f0a1a] p-4 font-mono text-xs leading-relaxed text-brand-100 shadow-inner ring-1 ring-brand-800",
